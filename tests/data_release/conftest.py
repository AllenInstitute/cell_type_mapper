...
@pytest.fixture(scope='module')
def cell_to_cluster_membership_pure_int_fixture(
        tmp_dir_fixture,
        cell_metadata_fixture):
    """
    Break the cell_metadata_fixture file up so that cluster_alias
    ...
    In this case, aliases are only ints. This will exercise
    failure due to comparison between ints and strings
    """
    new_cell_metadata_path = mkstemp_clean(
        dir=tmp_dir_fixture,
        prefix='cell_metadata_',
